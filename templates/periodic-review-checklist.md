# Periodic Risk Review Checklist

Use this alongside the risk register and heat map. Check off each item at the stated cadence; log the completion date so gaps in the review history are visible at a glance.

## Monthly (or Continuous)

- [ ] KRI dashboard reviewed by the risk/second-line function.
- [ ] Vulnerability scan and patch-latency metrics reviewed for cyber/operational KRIs.
- [ ] New risks from incidents, audit findings, or control self-assessments logged into the register.

## Quarterly

- [ ] Every open risk in the register re-scored (inherent and residual).
- [ ] Every risk owner confirmed still correct (no silent ownership gaps from staff turnover).
- [ ] Overdue treatment plans identified and escalated.
- [ ] Heat map regenerated and compared against the prior quarter for band movement.
- [ ] Compensating controls reviewed for continued justification and expiry-date status.
- [ ] KRI thresholds sanity-checked against recent actuals.
- [ ] Risk committee / leadership report prepared and delivered.
...
- [ ] Full framework/methodology re-alignment check (ISO 31000 / COSO ERM / NIST SP 800-30 fit-for-purpose review).
